...
## Overview
A machine learning pipeline that predicts whether an individual's annual income 
exceeds $50,000 based on demographic and employment features. Built entirely 
using Apache Spark (PySpark) for scalable, distributed data processing.
